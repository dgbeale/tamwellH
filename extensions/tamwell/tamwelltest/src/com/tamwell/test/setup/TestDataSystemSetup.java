 ...
 *
 */
package com.tamwell.test.setup;
...
import com.tamwell.test.constants.TamwellTestConstants;
import com.tamwell.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TamwellTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tamwelltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tamwelltest/import/reviews.impex");
			...
			importImpexFile(context, "/tamwelltest/import/cstickets.impex");
		}
	}
}
