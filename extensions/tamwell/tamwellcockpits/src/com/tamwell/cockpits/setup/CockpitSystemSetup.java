 ...
 *
 */
package com.tamwell.cockpits.setup;
...
import com.tamwell.cockpits.constants.TamwellCockpitsConstants;
 ...
 */
@SystemSetup(extension = TamwellCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TamwellCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TamwellCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TamwellCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/tamwellcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
