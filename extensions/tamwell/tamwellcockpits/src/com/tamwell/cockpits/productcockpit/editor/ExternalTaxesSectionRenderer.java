 ...
 *
 */
package com.tamwell.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("tamwellcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("tamwellcockpits.product.externalTaxes"));
