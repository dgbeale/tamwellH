 ...
 *
 */
package com.tamwell.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TamwellFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TamwellFulfilmentProcessConstants.PARENT_PROCESS);
